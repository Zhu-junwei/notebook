...
Write-Host "加载USB磁盘...`n" -ForegroundColor Green
...
foreach ($disk in $usbDisks) {
    ...
    Write-Host "正在联机磁盘 $diskNumber ($diskName) $sizeFormatted ..." -ForegroundColor Yellow
...
"@
    ...
    Write-Host "✓ 磁盘 $diskNumber 已成功联机" -ForegroundColor Green
    ...
    Write-Host "✓ 磁盘 $diskNumber 所在盘符 $driveLettersStr $sizeFormatted`n" -ForegroundColor Green
}

Write-Host "`n所有USB磁盘联机操作完成！" -ForegroundColor Cyan
